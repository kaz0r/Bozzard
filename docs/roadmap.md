...
- Implemented: textured 2D quads and indexed 3D cubes with depth testing, authored sun/ambient and point/spot lighting, shadows, procedural environment lighting, PBR materials, bloom and HDR display transforms, culling, and state caching. PNG/JPEG, OBJ, and glTF/GLB import supplement these built-ins.
...
- Full physics, audio, animation, input actions, cascaded shadows, baked GI, and production lighting/content systems.
