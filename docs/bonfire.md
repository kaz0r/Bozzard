...
Press **Play** in the editor. A central cube-built bonfire lights a dark forest clearing, stone hearth, charred logs and two benches. The fire has flickering orange light, real point-light shadows, glowing flame cubes, gentle flame-height animation, bloom and faint blue distance fog. The surrounding geometry is built from cubes too.
