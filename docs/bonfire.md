...
The scene also showcases the [post-processing stack](post-processing.md). Scene Settings exposes each effect and named presets; Play animates shimmer and grain. The authored exposure and bloom threshold remain tuned for this dark clearing.
