...
pub use scene::{
    ...
    SpotShadowSettings, SurfaceMaterialOverride, TextAlignment, TextMesh, TextureKind, ToneMapper,
    UploadContext, UploadData, UploadProgress, UploadSource, Vignette, VolumetricFog, text_bounds,
};
