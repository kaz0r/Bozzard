...
For the new **Sponza — The Gilded Hour** showcase, open `examples/sponza/showcase.json`: warm sunlight, baked GI, a rotating bronze armillary with shader-driven emission, subtle haze and courtyard reflections. Motion blur and depth of field are off. See [launch commands, cameras and capture instructions](docs/sponza-showcase.md).
