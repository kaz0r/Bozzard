...
Imported model base-color textures use GPU-generated mipmaps with trilinear repeat filtering and linear-light sRGB downsampling. Standalone images and procedural pixel-art textures retain nearest repeat filtering. Authored glTF sampler settings and full PBR remain unsupported.
